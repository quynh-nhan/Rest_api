...
var _index25 = _interopRequireDefault(require("../dereference/strategies/asyncapi-3/index.cjs"));
var _index26 = _interopRequireDefault(require("../bundle/strategies/openapi-3-1/index.cjs"));
var _index27 = require("../index.cjs");
Object.keys(_index27).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _index27[key]) return;
  exports[key] = _index27[key];
});
_index27.options.parse.parsers = [new _index9.default({
  allowEmpty: true,
  sourceMap: false
}), new _index0.default({
  allowEmpty: true,
...
_index27.options.resolve.resolvers = [new _indexNode.default(), new _index.default({
  timeout: 5000,
  redirects: 5,
  withCredentials: false
})];
_index27.options.resolve.strategies = [new _index2.default(), new _index3.default(), new _index4.default(), new _index5.default(), new _index6.default()];
_index27.options.dereference.strategies = [new _index21.default(), new _index22.default(), new _index23.default(), new _index24.default(), new _index25.default(), new _index20.default()];
_index27.options.bundle.strategies = [new _index26.default()];