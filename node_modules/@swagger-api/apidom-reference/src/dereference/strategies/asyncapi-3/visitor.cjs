...
var _apidomNsAsyncapi2 = require("@swagger-api/apidom-ns-asyncapi-3");
  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if ((0, _apidomCore.isPrimitiveElement)(referencedElement)) {
      ...
      if (this.refractCache.has(cacheKey)) {
        ...
        referencedElement = _apidomNsAsyncapi2.ReferenceElement.refract(referencedElement);
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'error') {
        ...
        const replacer = (_this$options$derefer = (_this$options$derefer2 = this.options.dereference.strategyOpts['asyncapi-3']) == null ? void 0 : _this$options$derefer2.circularReplacer) != null ? _this$options$derefer : this.options.dereference.circularReplacer;
    ...
    if ((isExternalReference || isNonRootDocument || (0, _apidomNsAsyncapi2.isReferenceElement)(referencedElement) || shouldDetectCircular) && !ancestorsLineage.includesCycle(referencedElement)) {
      ...
      referencedElement = await visitAsync(referencedElement, visitor, {
        keyMap: _apidomNsAsyncapi2.keyMap,
...
var _default = exports.default = AsyncAPI3DereferenceVisitor;